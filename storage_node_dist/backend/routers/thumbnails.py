...
def _evict_lru():
    """Delete oldest thumbnails if cache exceeds budget."""
    budget = settings.thumbnail_cache_budget_mb
    if budget <= 0:
        return  # unlimited
    ...
    while total > budget_bytes and files:
        ...
        try:
            ...
            pass
    logger.info("Thumbnail LRU eviction: freed to %d MB", total // (1024 * 1024))
